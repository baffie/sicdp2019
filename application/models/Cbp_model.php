...
class Cbp_model extends CI_Model
{
     ...
     function grid_filter()
    {
        ...
        {
            $this->datatables->where('b.bulan',$this->input->get('bulan'));
        }
