...
class Data_cbpkab_model extends CI_Model
{

    public $table ='data_cbpkab';
    public $id = 'id_cbpkab';
    public $order = 'DESC';
    ...
    /*function grid($id=null)
    {
        ...
        if($id){
            ...
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'auth/data_cbpkab/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'auth/data_cbpkab/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
        }else{
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'cms/data_cbpkab/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'cms/data_cbpkab/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
        }
       ...
       function grid($id=null)
       {
        $this->load->database();
        $this->load->library("datatables");
        $this->datatables->select("p.id_cbpkab as id,
        b.nama_kab,
        p.bulan,
        p.tahun, 
        p.stok_awal, 
    ...
    function get_stok_cbpkab($id_kabupaten)
    {
        $return = $id_kabupaten ;
        if($id_kabupaten){
        ...
        $this->db->order_by('id_cbpkab','DESC');
        $this->db->limit(1);
        $rs = $this->db->get();
...
/* End of file data_cbpkab_model.php */
/* Location: ./application/models/data_cbpkab_model.php */