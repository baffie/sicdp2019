...
class Data_cp_lainnya_model extends CI_Model
{

    public $table ='data_cp_lainnya';
    public $id = 'id_cp_lainnya';
    public $order = 'DESC';
    ...
    /*function grid($id=null)
    {
       ...
       function grid($id=null)
       {
        $this->load->database();
        $this->load->library("datatables");
        $this->datatables->select("p.id_cp_lainnya as id,
        b.nama_kab,
        p.bulan,
        p.tahun, 
        p.stok_awal, 
        ...
        if($id){
            ...
            $this->datatables->add_column('action',' <a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'auth/data_cp_lainnya/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'auth/data_cp_lainnya/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
            ...
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'cms/data_cp_lainnya/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'cms/data_cp_lainnya/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
            $this->datatables->add_column('lokasi','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="lokasi" href="https://www.google.co.id/maps/place/$1" target="_blank"><i class="fa fa-map"></i></button>','lokasi');
        }
        return $this->datatables->generate();
    }
    ...
    function get_stok_cp_lainnya($id_kabupaten)
    {
        $return = $id_kabupaten ;
        if($id_kabupaten){
        ...
        $this->db->order_by('id_cp_lainnya','DESC');
        $this->db->limit(1);
        $rs = $this->db->get();
...
/* End of file Data_cp_lainnya_model.php */
/* Location: ./application/models/Data_cp_lainnya_model.php */