...
class Data_cpp_ldpm_model extends CI_Model
{

    public $table = 'data_cpp_ldpm';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function grid($id=null)
       {
        ...
        p.created, ", false)
            ...
            ->join('cpp_ldpm g', 'g.id_gapoktan = p.id_gapoktan', 'left');
        ...
        if($id){
            ...
            $this->datatables->add_column('action','<a class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Rekap" href="'.site_url().'auth/Data_cpp_ldpm/rekap/$1"><i class="fa fa-eye"></i></a> <a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'auth/data_cpp_ldpm/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'auth/data_cpp_ldpm/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
            ...
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'cms/data_cpp_ldpm/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'cms/data_cpp_ldpm/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
            $this->datatables->add_column('lokasi','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="lokasi" href="https://www.google.co.id/maps/place/$1" target="_blank"><i class="fa fa-map"></i></button>','lokasi');
        }
    ...
    function get_by_id($id)
    {
     ...
     public function get_stok_cpp_ldpm($id_gapoktan)
    {
        $return = $id_gapoktan ;
        if($id_gapoktan)
        {
            ...
            $this->db->order_by('id_gapoktan','DESC');
            $this->db->limit(1);
            $rs = $this->db->get();
...
/* End of file Data_cpp_Data_cpp_ldpm.php */
/* Location: ./application/models/Data_cpp_Data_cpp_ldpm.php */