...
class Data_cppdesa_model extends CI_Model
{

    public $table ='data_cppdesa';
    public $id = 'id_cppdesa';
    public $order = 'DESC';
    ...
    /*function grid($id=null)
    {
        ...
        if($id){
            ...
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'auth/data_cppdesa/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'auth/data_cppdesa/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
        }else{
            $this->datatables->add_column('action','<a class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="'.site_url().'cms/data_cppdesa/update/$1"><i class="fa fa-edit"></i></a> <button onclick="return confirmModal(\''.base_url().'cms/data_cppdesa/delete/$1\')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></button>','id');
        }
       ...
       function grid($id=null)
       {
        $this->load->database();
        $this->load->library("datatables");
        $this->datatables->select("p.id_cppdesa as id,
        b.nama_kab,
        c.nama_kec,
        d.nama_kel,
        p.bulan,
    ...
    function get_stok_cppdesa($id_kabupaten)
    {
        $return = $id_kabupaten ;
        if($id_kabupaten){
        ...
        $this->db->order_by('id_cppdesa','DESC');
        $this->db->limit(1);
        $rs = $this->db->get();
...
/* End of file data_cppdesa_model.php */
/* Location: ./application/models/data_cppdesa_model.php */