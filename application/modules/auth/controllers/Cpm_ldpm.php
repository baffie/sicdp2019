...
class Cpm_ldpm extends Frontend_Controller
{
    ...
    public function index()
    {
        ...
        $data['source'] = site_url('auth/cpm_ldpm/grid');
    ...
    public function create()
    {
        ...
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('auth/cpm_ldpm/create_action'),
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('auth/cpm_ldpm'));
        }
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Edit',
                'action' => site_url('auth/cpm_ldpm/update_action'),
