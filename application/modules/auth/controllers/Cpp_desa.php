...
class Cpp_desa extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('auth/cpp_desa/grid');
    ...
    function grid()
    {
        ...
        echo $this->Cpp_desa_model->grid($this->user->id);
    }
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			redirect(site_url('auth/cpp_desa'));
		}
	}
	...
	public function create()
	{
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('auth/cpp_desa/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('auth/cpp_desa/update_action'),
