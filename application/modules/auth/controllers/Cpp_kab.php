...
class Cpp_kab extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('auth/cpp_kab/grid');
		...
		$template['page_heading'] = 'Data Awal Pengadaan CPP Kab/kota';
		$template['content'] = $this->load->view('cpp_kab/list', $data, true);
    ...
    function grid()
    {
        ...
        echo $this->Cpp_kab_model->grid($this->user->id);
    }
 	...
 	public function rekap($id)
	{
		...
		$template['page_heading'] = 'Rekap Data CPP Kab/kota';
		$template['content'] = $this->load->view('cpp_kab/rekap', $data, true);
		$this->load->view('layouts/dashboard', $template);
	}
	...
	public function cetak($id)
	{
		...
		$template['page_heading'] = 'Rekap Data CPP Kab/kota';
		$template['content'] = $this->load->view('cpp_kab/print', $data, true);
		$this->load->view('layouts/print', $template);
	}

	public function read($id)
	{
		$row = $this->Cpp_kab_model->get_by_id($id);
		if ($row) {
			$data = array(
				'id' => $row->id,
			...
			$template['page_heading'] = 'Data Awal Pengadaan CPP Kab/kota';
			$template['content'] = $this->load->view('cpp_kab/read', $data, true);
			$this->load->view('layouts/dashboard', $template);

		} else {
			$this->session->set_flashdata('error', 'Data tidak ditemukan');
			redirect(site_url('auth/cpp_kab'));
		}
	}
	...
	public function create()
	{
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('auth/cpp_kab/create_action'),
		...
		$template['page_heading'] = 'Data Awal Pengadaan CPP Kab/kota';
		$template['content'] = $this->load->view('cpp_kab/form', $data, true);
        $template['js'] = $this->load->view('cpp_kab/js', $data, true);
		$template['css'] = $this->load->view('cpp_kab/css', $data, true);
		$this->load->view('layouts/dashboard', $template);
	}
	...
	public function create_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Cpp_kab_model->insert($data);
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('auth/cpp_kab/update_action'),
	...
	public function update_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->Cpp_kab_model->update($this->input->post('id_cpp', TRUE), $data);
    ...
    public function valid($id, $status)
    {
        ...
        $this->Cpp_kab_model->update($id, $data);
        $this->session->set_flashdata('success', 'Data berhasil diupdate');
        redirect('auth/cpp_kab');
    }
    ...
    public function excel()
    {
        ...
        $template = 'template_excel/cpp_kab_kota.xlsx';
        ...
        $data = $this->Cpp_kab_model->get_all();
...
/* End of file cpp_kab.php */
/* Location: ./application/controllers/cpp_kab.php */