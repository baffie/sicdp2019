...
class Data_cppdesa extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('auth/data_cppdesa/grid');
    ...
    function grid()
    {
        ...
        echo $this->Data_cppdesa_model->grid($this->user->id);
    }
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			redirect(site_url('auth/data_cppdesa'));
		}
	}
	...
	public function create()
	{
		...
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('auth/data_cppdesa/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('auth/data_cppdesa/update_action'),
