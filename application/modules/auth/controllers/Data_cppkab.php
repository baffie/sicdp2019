...
class Data_cppkab extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('auth/data_cppkab/grid');
		...
		$template['content'] = $this->load->view('data_cppkab/list', $data, true);
        $template['js'] = $this->load->view('data_cppkab/js', $data, true);
    ...
    function grid()
    {
        ...
        echo $this->Data_cppkab_model->grid($this->user->id);
    }
    ...
    function grid_filter()
    {
        ...
        echo $this->Data_cppkab_model->grid_filter();
    }
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			redirect(site_url('auth/data_cppkab'));
		}
	}
	...
	{
		$stok_awal = $this->Data_cppkab_model->get_stok_cppkab();
		//die($stok_awal);
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('auth/data_cppkab/create_action'),
			'id_cppkab' => set_value('id_cppkab'),
		...
		$template['page_heading'] = 'Data CPP Kab/kota';
		$template['content'] = $this->load->view('data_cppkab/form', $data, true);
        $template['js'] = $this->load->view('data_cppkab/js', $data, true);
		$template['css'] = $this->load->view('data_cppkab/css', $data, true);
		$this->load->view('layouts/dashboard', $template);
	}
	...
	public function create_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			//print_r ($data);
			//die();
			$this->Data_cppkab_model->insert($data);
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('auth/data_cppkab/update_action'),
				'id_cppkab' => set_value('id_cppkab', $row->id_cppkab),
	...
	public function update_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			$this->update($this->input->post('id_cppkab', TRUE));
		} else {
			$data = array(
				'id_penyuluh' => $this->input->post('id_penyuluh',TRUE),
			...
			$this->Data_cppkab_model->update($this->input->post('id_cppkab', TRUE), $data);
	...
	public function delete($id)
	{
		...
		if ($row) {
			$this->Data_cppkab_model->delete($id);
    ...
    public function valid($id, $status)
    {
        ...
        $this->Data_cppkab_model->update($id, $data);
        $this->session->set_flashdata('success', 'Data berhasil diupdate');
        redirect('auth/data_cppkab');
    }
	...
	public function _rules()
	{
		...
		$this->form_validation->set_rules('id_cppkab', 'id_cppkab', 'trim');
...
/* End of file data_cppkab.php */
/* Location: ./application/controllers/data_cppkab.php */