...
class Lpm extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['source'] = site_url('auth/lpm/grid');
	...
	function grid()
	{
		...
		echo $this->Lpm_model->grid($this->user->id);
	}
	...
	public function create()
	{
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('auth/lpm/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('auth/lpm/update_action'),
