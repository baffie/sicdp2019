...
<script type="text/javascript">
    $('#tahun_berdiri').datetimepicker({
        ...
        $('#bulan_pengadaan').datetimepicker({
        format: 'MMMM',
        locale: 'id'
    });
...
<script type="text/javascript">
   ...
   /* var table = $('#table').dataTable({
        ...
        "columns": [
            ...
            { "data": "foto",
                "render": function ( data, type, row ) {
                    return '<img src="<?php echo base_url('uploads/')?>'+data+'" class="img-thumbnail" style="width:100px;" />';
                }
            },
            { "data": "action" }
        ]
    ...
    $("#form_filter").submit(function(){
        ...
        table.fnReloadAjax('<?php echo site_url()?>cms/poktan/grid_filter?'+post_data);
        return false;
    });
    */
    ...
    $("#form_filter").submit(function(){
        var post_data=$(this).serialize();
        table.fnReloadAjax('<?php echo site_url()?>cms/cpm_lpm/grid_filter?'+post_data);
        return false;
    });
