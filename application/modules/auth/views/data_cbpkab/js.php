...
<script type="text/javascript">
    ...
    $("#form_filter").submit(function(){
        ...
        table.fnReloadAjax('<?php echo site_url()?>auth/data_cbpkab/grid_filter?'+post_data);
        return false;
    });
...
function getStokAwal(){
    ...
    //var txt = $("input").val();
    $.post("<?php echo site_url()?>/ajax/get_stok_cbpkab", {id_kabupaten: id}, function(result){
        //alert (result);
