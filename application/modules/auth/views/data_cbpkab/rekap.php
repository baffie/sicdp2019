<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
            <?php echo anchor(site_url('auth/data_cbpkab/cetak/'.$id_kabupaten), '<i class="fa fa-print"></i> Cetak', 'class="btn btn-danger" title="Tambah"'); ?>
            <!--<?php echo anchor(site_url('auth/data_cbpkab/excel/'.$id_kabupaten), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" title="Unduh Excel"'); ?>-->
        </h3>
    ...
    <div class="box-body">
        <h3 class="text-center">REKAPITULASI CBP TINGKAT KABUPATEN / KOTA</h3>
        ...
        <table class="table table-bordered vertical-align">
            ...
            <tr class="active">
                ...
                <th class="text-center" colspan="5">Rekapitulasi CBP Tingkat Kabupaten/kota (Kg)</th>
            </tr>
            <tr class="active">
