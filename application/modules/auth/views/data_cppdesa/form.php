...
<form action="<?php echo $action; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="box">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <?php echo form_dropdown('id_desa', $load_kelurahan, $id_desa, 'id="id_desa" class="form-control select2" id="id_kabupaten" onChange="getStokAwal()"'); ?>
                </div>
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="number" class="form-control" name="stok_awal" id="stok_awal" placeholder="stok awal" value="<?php echo $stok_awal; ?>" size="10" maxlength="10" onKeyPress="return goodchars(event,'0123456789',this)" />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="box-footer">
            <input type="hidden" name="id_cppdesa" value="<?php echo $id_cppdesa; ?>" />
            ...
            <a href="<?php echo site_url('auth/data_cppdesa') ?>" class="btn btn-default">Batal</a>
        </div>
    </div>
</form>
