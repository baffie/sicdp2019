...
<div class="row">
    <div class="col-md-12" style="padding:0px">
        <ol class="breadcrumb" itemprop="BreadcrumList" itemscope="BreadcrumbList" itemtype="http://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope="ListItem" itemtype="http://schema.org/ListItem" class="active" itemprop="item"><span itemprop="name"><?php echo ucfirst($channel) ?></span></li>
        </ol>
    </div>
</div>
...
<div class="row mb15">
    <div class="col-md-9">
        <h1 class="page-header mt0"><?php echo ucfirst($channel) ?></h1>
        <?php if($detail->result_array()) {?>
        <ul class="media-list">
            <?php
