...
class Auth extends Frontend_Controller {
	...
	function index()
	{
        ...
        //$this->load->model('Cpm_lpm_model');
        //$this->load->model('Cpm_ldpm_model');
        //$this->load->model('Data_cpm_lpm_model');
        //$this->load->model('Data_cpm_ldpm_model');
		...
		else
		{
            ...
            $data['user'] = $this->user;
            $data['total_lpm'] = $this->Lpm_model->get_total($this->user->id);
            $data['total_ldpm'] = $this->Ldpm_model->get_total($this->user->id);
            $data['total_cpp'] = $this->Cpp_kab_model->get_total($this->user->id);
            $data['total_cpm_ldpm'] = $this->Gapoktan_model->get_total($this->user->id);
            $data['total_cpm_lpm'] = $this->Poktan_model->get_total($this->user->id);
            $data['total_data_cppkab'] = $this->Data_cppkab_model->get_total($this->user->id);

            $template['page_heading'] = 'Dashboard';
            $template['content'] = $this->load->view('index', $data, true);
