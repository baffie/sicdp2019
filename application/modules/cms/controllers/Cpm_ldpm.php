...
class Cpm_ldpm extends Frontend_Controller
{
    ...
    public function index()
    {
        ...
        $data['source'] = site_url('cms/cpm_ldpm/grid');
        $data['load_cities']	= $this->Kabupaten_model->get_category_select(array('' => 'Kabupaten / Kota'));
        $template['page_heading'] = 'DATA MASTER CPM LDPM';
        $template['content'] = $this->load->view('cpm_ldpm/list', $data, true);
        $template['js'] = $this->load->view('cpm_ldpm/js', $data, true);
        $template['css'] = $this->load->view('cpm_ldpm/css', $data, true);
    ...
    public function rekap($id=null)
    {
        ...
        $template['content'] = $this->load->view('cpm_ldpm/rekap', $data, true);
        $this->load->view('backend/layouts/dashboard', $template);
    }
    ...
    public function cetak($id=null)
    {
        ...
        $template['page_heading'] = 'DATA CPM LDPM';
        $template['content'] = $this->load->view('cpm_ldpm/print', $data, true);
    ...
    public function create()
    {
        ...
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('cms/cpm_ldpm/create_action'),
        ...
        $template['content'] = $this->load->view('cpm_ldpm/form', $data, true);
        $template['css'] = $this->load->view('cpm_ldpm/css', $data, true);
        $template['js'] = $this->load->view('cpm_ldpm/js', $data, true);
        $this->load->view('backend/layouts/dashboard', $template);
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('cms/cpm_ldpm'));
        }
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('cms/cpm_ldpm/update_action'),
