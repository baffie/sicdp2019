...
class Cpm_lpm extends CI_Controller
{
    ...
    //$this->output->enable_profiler(TRUE);
        ...
        $data['source'] = site_url('cms/cpm_lpm/grid');
        ...
        $template['page_heading'] = 'Data MASTER CPM LPM';
    ...
    //$this->output->enable_profiler(TRUE);
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('cms/cpm_lpm/create_action'),
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('cms/cpm_lpm/update_action'),
