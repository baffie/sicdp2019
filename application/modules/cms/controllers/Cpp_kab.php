...
class Cpp_kab extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('cms/cpp_kab/grid');
	...
	public function create()
	{
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('cms/cpp_kab/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('cms/cpp_kab/update_action'),
