...
class Data_cbpkab extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('cms/data_cbpkab/grid');
    ...
    function grid()
    {
        ...
        echo $this->Data_cbpkab_model->grid();
    }
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			redirect(site_url('cms/data_cbpkab'));
		}
	}
	...
	public function create()
	{
		...
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('cms/data_cbpkab/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('cms/data_cbpkab/update_action'),
