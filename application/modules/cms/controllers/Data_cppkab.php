...
class Data_cppkab extends CI_Controller
{
	...
	public function index()
	{
        ...
        $data['source'] = site_url('cms/data_cppkab/grid');
    ...
    function grid()
    {
        ...
        echo $this->Data_cppkab_model->grid();
    }
	...
	public function create()
	{
		...
		$data = array(
			'button' => 'Tambah',
			'action' => site_url('cms/data_cppkab/create_action'),
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('cms/data_cppkab/update_action'),
