...
class Kabupaten_ldpm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $rdkk = $this->Home_model->get_all_by_prov_ldpm($bulan, $tahun);
        //print_r($stok);
        //die();        
        $data = array(
            'rdkk_data' => $rdkk,
        ...
        $template['content'] = $this->load->view('cpm/v_kab_ldpm', $data, true);
    ...
    public function set()
    {
        ...
        redirect(site_url('cms/cpm/kabupaten_ldpm'));
    }
}