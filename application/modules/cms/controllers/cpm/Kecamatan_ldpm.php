...
class Kecamatan_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_kecamatan_cpm_ldpm_cms ($kecamatan);
        print_r($kecamatan);
        $data = array(
            'data_poktan' => $poktan
        );
        ...
        $template['page_heading'] = 'Data CPM LDPM  Tingkat Kecamatan';
        $template['content'] = $this->load->view('cpm/v_kecamatan_ldpm', $data, true);
    ...
    public function view($id=null)
    {
        ...
        $id OR show_404();
         ...
         $this->load->model('Gapoktan_model');
                ...
                $poktan = $this->Home_model->get_by_id_kota_cpm_ldpm($id);
                //$poktan = $this->Home_model->get_stok_kabupaten_poktan($id);      
                $rdkk = $this->Home_model->get_all_by_kota_cpm_ldpm_test($id);
    ...
    public function set()
    {
        ...
        redirect(site_url('cpm/kecamatan_ldpm'));
    }
