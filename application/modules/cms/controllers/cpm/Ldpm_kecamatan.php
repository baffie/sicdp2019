...
class Ldpm_kecamatan extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $template['page_heading'] = 'REKAP DATA CPM LDPM BY AREA';
    ...
    public function view($id=null)
    {
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('cpm/v_ldpm_kecamatan_detail', $data, true);
        $template['js'] = $this->load->view('cpm/js', $data, true);
