...
class Lpm_kecamatan extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $template['page_heading'] = 'Rekap Data CPM LPM';
        $template['content'] = $this->load->view('cpm/v_kecamatan', $data, true);
    ...
    public function view($id=null)
    {
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('cpm/v_lpm_kecamatan_detail', $data, true);
        $template['js'] = $this->load->view('cpm/js', $data, true);
