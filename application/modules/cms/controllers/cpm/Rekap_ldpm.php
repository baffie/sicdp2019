...
class Rekap_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $template['content'] = $this->load->view('cpm/v_rekap_ldpm', $data, true);
    ...
    public function view($id=null)
    {
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('cpm/v_desa_detail_ldpm', $data, true);
        $template['js'] = $this->load->view('cpm/js', $data, true);
