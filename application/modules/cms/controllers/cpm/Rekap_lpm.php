...
class Rekap_lpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $template['page_heading'] = 'REKAP DATA CPM LPM BY AREA';
        $template['content'] = $this->load->view('cpm/v_rekap_lpm', $data, true);
    ...
    public function view($id=null)
    {
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('cpm/v_desa_detail', $data, true);
        $template['js'] = $this->load->view('cpm/js', $data, true);
