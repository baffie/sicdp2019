...
class Cpp_desa extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_cpp_desa($kecamatan, $desa);
        //print_r($poktan);
        //die();
        $data = array(
            'data_poktan' => $poktan
        ...
        $template['page_heading'] = 'Rekap CPP Desa';
        $template['content'] = $this->load->view('rekap_cpp_desa/v_cpp_desa_rekap', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_kota_cpp_desa($id);
                //print_r($poktan);
                //die();
                $rdkk = $this->Home_model->get_all_by_cpp_desa_detail($id);
                //print_r($rdkk);
        ...
        $template['title'] = 'Rekap CPP DESA';
        $template['content'] = $this->load->view('rekap_cpp_desa/v_cppdesa_detail', $data, true);
        $template['js'] = $this->load->view('rekap_cpp_desa/js', $data, true);
    ...
    public function set()
    {
        ...
        redirect(site_url('cpp/cpp_kab_detail'));
    }
