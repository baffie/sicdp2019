...
class Desa_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        //print_r($kabupaten);
        //die();
        $poktan = $this->Home_model->get_search_kecamatan_cpm_ldpm_cms_by_desa($desa);
        ...
        $template['page_heading'] = 'REKAP CPM LDPM BY Desa/kelurahan';
        $template['content'] = $this->load->view('profile/v_desa_kelompok_ldpm', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_desa_cpm_ldpm_cms($id);
                //$poktan = $this->Home_model->get_stok_kabupaten_poktan($id);      
                $rdkk = $this->Home_model->get_all_by_desa_cpm_ldpm_cms($id);
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('profile/v_ldpm_desa_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
