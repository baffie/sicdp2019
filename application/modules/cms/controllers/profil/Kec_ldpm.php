...
class Kec_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        //print_r($kabupaten);
        //die();
        $poktan = $this->Home_model->get_search_kecamatan_cpm_ldpm_cms_by_kecamatan($kecamatan);
        ...
        $template['page_heading'] = 'REKAP CPM LDPM BY Kecamatan';
        $template['content'] = $this->load->view('profile/v_kecamatan_kelompok_ldpm', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_kecamatan_cpm_ldpm_cms($id);
                //$poktan = $this->Home_model->get_stok_kabupaten_poktan($id);      
                $rdkk = $this->Home_model->get_all_by_kecamatan_cpm_ldpm_cms($id);
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('profile/v_ldpm_kecamatan_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
