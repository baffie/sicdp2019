...
class Kecamatan_lpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        //print_r($kabupaten);
        //die();
        $poktan = $this->Home_model->get_search_kecamatan_cpm_lpm_cms_by_kecamatan($kecamatan);
        ...
        $template['page_heading'] = 'REKAP CPM LPM BY Kecamatan';
        $template['content'] = $this->load->view('profile/v_kecamatan_kelompok', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_kota_cpm_lpm_cms($id);
                //$poktan = $this->Home_model->get_stok_kabupaten_poktan($id);      
                $rdkk = $this->Home_model->get_all_by_kota_cpm_lpm_cms($id);
       ...
       //       die();
        ...
        $template['content'] = $this->load->view('profile/v_lpm_kecamatan_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
