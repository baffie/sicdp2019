...
class Kota_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_kota_cpm_ldpm($kabupaten);
        //print_r($poktan);
        //die();
        $data = array(
            'data_poktan' => $poktan
        ...
        $template['title'] = 'Data CPM LDPM Tingkat Kabupaten / Kota';
        $template['content'] = $this->load->view('profile/v_kabupaten_ldpm', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $rdkk = $this->Home_model->get_all_by_kota_cpm_ldpm($id);
                //print_r($rdkk);
        ...
        $template['content'] = $this->load->view('profile/v_kabupaten_ldpm_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
    ...
    public function set()
    {
        ...
        redirect(site_url('cpm/kota_ldpm'));
    }
