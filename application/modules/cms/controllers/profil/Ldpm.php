...
class Ldpm extends MX_Controller
{
    ...
    {   
        ...
        $poktan = $this->Home_model->get_search_gapok_cms($kabupaten);
        ...
        $template['page_heading'] = 'REKAP CPM LDPM BY Kelompok';
        $template['content'] = $this->load->view('profile/v_ldpm', $data, true);
    ...
    public function view($slug=null)
    {
        ...
        $template['content'] = $this->load->view('profile/v_gapok_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
        ...
        public function data($slug=null)
    {
        ...
        $template['title'] = 'PROFIL CPM LPM';
        $template['content'] = $this->load->view('profile/v_ldpm_profil', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
        $this->load->view('frontend/layouts/print', $template);
    }
