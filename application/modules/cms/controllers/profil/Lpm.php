...
class Lpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_cms($kabupaten);
        ...
        $template['page_heading'] = 'REKAP CPM LPM BY Kelompok';
        $template['content'] = $this->load->view('profile/v_poktan', $data, true);
    ...
    public function view($slug=null)
    {
        ...
        if(count($rdkk) < 1){
            //redirect(site_url(cms/profil/lpm), 'location', 301);
        }
        ...
        $template['content'] = $this->load->view('profile/v_poktan_detail', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
    ...
    public function data($slug=null)
    {
        ...
        $template['title'] = 'PROFIL CPM LPM';
        $template['content'] = $this->load->view('profile/v_poktan_profil', $data, true);
        $template['js'] = $this->load->view('profile/js', $data, true);
        $this->load->view('frontend/layouts/print', $template);
    }
