<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title">
			<?php echo anchor(site_url('cms/bulog/create'), '<i class="fa fa-plus-circle"></i> Tambah', 'class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah"'); ?>
			<?php echo anchor(site_url('cms/bulog/excel'), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Unduh Excel"'); ?>
		</h3>
