<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
            <?php echo anchor(site_url('auth/cbp_kab/cetak/'.$id_poktan), '<i class="fa fa-print"></i> Cetak', 'class="btn btn-danger" title="Tambah"'); ?>
    ...
    <div class="box-body">
        <h3 class="text-center">REKAPITULASI CBP KAB/KOTA DETAIL</h3>
