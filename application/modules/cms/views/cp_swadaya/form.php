    ...
    <form action="<?php echo $action; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="box-body">
            <div class="form-group">
                <label class="col-sm-2 control-label">Nama Kelompok Swadaya <?php echo form_error('nama_poktan') ?></label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nama_poktan" id="nama_poktan" placeholder="Nama Kelompok Swadaya" value="<?php echo $nama_poktan; ?>" />
                </div>
            </div>
           <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="nama_ketua" id="nama_ketua" placeholder="Nama Ketua Kelompok Swadaya" value="<?php echo $nama_ketua; ?>" />
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="box-footer">
            <input type="hidden" name="id_swadaya" value="<?php echo $id_swadaya; ?>" />
            <input type="hidden" name="id_penyuluh" value="<?php echo $id_penyuluh; ?>" />
            <button type="submit" class="btn btn-primary"><?php echo $button ?></button>
            <a href="<?php echo site_url('auth/cpm_lpm') ?>" class="btn btn-default">Batal</a>
        </div>
    </form>
</div>