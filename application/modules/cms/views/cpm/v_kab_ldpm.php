<div class="row hidden-print">
    <div class="col-md-5">
        <?php echo form_open('cms/cpm/kabupaten_ldpm/set', array('class' => 'form-inline')); ?>
...
<h3 class="text-center">REKAPITULASI CADANGAN PANGAN MASYARAKAT (LPM) KABUPATEN PANDEGLANG</h3>
<p>
</br>
...
<table class="table table-bordered vertical-align">
    ...
    <tr class="active">
        ...
        <th class="text-center" width="10%" rowspan="3">Kecamatan</th>
...
*untuk <strong>Validasi</strong> pilih menu <strong>Master</strong> -> pilih <strong>CPM LPM</strong> -> Pilih Data yang akan di edit -> <strong>Edit</strong> -> pilih opsi validasi -> <strong>Simpan</strong>
</p>
