...
<table class="table table-no-bordered" id="mytable">
    ...
    <tr>
        <th width="800px"></th>
        <th width="200px">
            <a href="<?php echo site_url('cms/cpm/rekap_lpm'); ?>" class="btn btn-sm btn-primary" ><i class="fa fa-share"></i> Rekap Desa</a>
        </th>
        <th width="200px">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row) {
            ...
            <tr>
                ...
                <td align = "left"><a href="<?php echo site_url('cms/cpm/lpm_kecamatan/view/' . $row['id_kecamatan']); ?>"
                       title="<?php echo $row['nama_kec'] ?>" target="_blank"><?php echo $row['nama_kec'] ?></a></td>
                <td>
                    <a href="<?php echo site_url('cms/cpm/lpm_kecamatan/view/' . $row['id_kecamatan']); ?>"
