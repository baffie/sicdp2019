...
<h3 class="text-center">REKAPITULASI CPM LDPM KABUPATEN PANDEGLANG </h3><br>
<p>
...
<table class="table table-bordered vertical-align">
    ...
    <tr class="active">
        ...
        <th class="text-center" width="15%" rowspan="3">Kelurahan/desa</th>
...
*untuk <strong>Validasi</strong> pilih menu <strong>Master</strong> -> pilih <strong>CPM LDPM</strong> -> Pilih Data yang akan di edit -> <strong>Edit</strong> -> pilih opsi validasi -> <strong>Update</strong><br>
*kemudian pilih menu <strong>Data</strong> -> pilih <strong>DATA CPM LDPM</strong> -> Pilih Data yang akan di edit -> <strong>Edit</strong> -> pilih opsi validasi -> <strong>Update</strong>
</p>