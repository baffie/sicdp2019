...
<table class="table table-no-bordered" id="mytable">
    ...
    <tr>
        <th width="800px"></th>
        <th width="100px">
            <a href="<?php echo site_url('cms/cpm/ldpm_kecamatan'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-share"></i> Rekap Kecamatan</a>
        </th>
        <th width="100px">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row) {
            ...
            <tr>
                ...
                <td align = "left"><a href="<?php echo site_url('cms/cpm/rekap_ldpm/view/' . $row['id_desa']); ?>"
                       title="<?php echo $row['nama_kel'] ?>" target="_blank"><?php echo $row['nama_kel'] ?></a></td>
                <td>
                    <a href="<?php echo site_url('cms/cpm/rekap_ldpm/view/' . $row['id_desa']); ?>"
