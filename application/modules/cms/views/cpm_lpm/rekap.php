<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
            <?php echo anchor(site_url('auth/cpm_lpm/cetak/'.$id_poktan), '<i class="fa fa-print"></i> Cetak', 'class="btn btn-danger" title="Tambah"'); ?>
            <?php echo anchor(site_url('auth/cpm_lpm/excel/'.$id_poktan), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" title="Unduh Excel"'); ?>
        </h3>
