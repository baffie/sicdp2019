    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select name="validasi" id="validasi" class="form-control select2">
                        <option value="0" <?php echo ($validasi == '0')?' selected':'' ?>>Belum Validasi</option>
                        <option value="1" <?php echo ($validasi == '1')?' selected':'' ?>>Tervalidasi</option>
                    </select>
                </div>
            </div>
        <div class="box-footer">
            ...
            <input type="hidden" name="bulan_pengadaan" value="<?php echo $bulan_pengadaan; ?>" />
            <input type="hidden" name="tahun_pengadaan" value="<?php echo $tahun_pengadaan; ?>" />
            <button type="submit" class="btn btn-primary"><?php echo $button ?></button>
            <a href="<?php echo site_url('cms/cpp_desa') ?>" class="btn btn-default">Batal</a>
        </div>
    </div>
</form>
