...
<div class="row hidden-print">
    <div class="col-md-5">
        <?php echo form_open('cms/cpp/cpp_kab_detail/set', array('class' => 'form-inline')); ?>
...
<h3 class="text-center">REKAPITULASI CPP KABUPATEN PANDEGLANG<br></h3>
<p>
<br>
...
<table class="table table-bordered vertical-align">
    ...
    <tr class="active">
        ...
        <th class="text-center" colspan="7">CPP (Kg)</th>
