    ...
    <div class="box">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Stok Awal<?php echo form_error('stok_awal') ?></label>*untuk pertama kali input, sesuaikan dengan stok awal pengadaan
                <div class="col-sm-2">
        ...
        <div class="box-footer">
            <input type="hidden" name="id_cp_lainnya" value="<?php echo $id_cp_lainnya; ?>" />
            ...
            <a href="<?php echo site_url('cms/data_cp_lainnya') ?>" class="btn btn-default">Batal</a>
        </div>
    </div>
</form>
