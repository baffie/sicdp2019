    ...
    <div class="box">
        <div class="box-header with-border">
           ...
           <div class="box-body">
             <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php echo form_dropdown('id_kab', $cities, $id_kab, 'class="form-control select2" id="id_kabup"'); ?>
                </div>
            </div>
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php echo form_dropdown('id_gapoktan', $options_cpp_ldpm, $id_gapoktan, 'class="form-control select2" id="id_gapoktan" onChange="getStokAwal()"'); ?>
                </div>
            </div>
        <div class="form-group">
        ...
        <div class="form-group <?php echo form_error('attach_file') ? 'has-error has-feedback' : '' ?>">
            ...
            <div class="col-sm-6">
                ...
                <span class="help-block">File extension: <strong>PDF (.pdf) Max 5 Mb</strong></span>
                <?php
        ...
        <div class="box-footer">
            ...
            <a href="<?php echo site_url('cms/data_cpp_ldpm') ?>" class="btn btn-default">Batal</a>
        </div>
    </div>
</form>
