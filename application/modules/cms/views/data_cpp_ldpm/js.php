...
<script type="text/javascript">
    ...
    $("#form_filter").submit(function(){
        ...
        table.fnReloadAjax('<?php echo site_url()?>cms/data_cpp_ldpm/grid_filter?'+post_data);
        return false;
    });
...
function getStokAwal(){
    ...
    //var txt = $("input").val();
    $.post("<?php echo site_url()?>/ajax/get_stok_cpp_ldpm", {id_gapoktan: id}, function(result){
        //alert (result);
