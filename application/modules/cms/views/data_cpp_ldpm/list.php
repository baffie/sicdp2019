...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title">
			<?php echo anchor(site_url('cms/data_cpp_ldpm/create'), '<i class="fa fa-plus-circle"></i> Tambah', 'class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah"'); ?>
			<?php echo anchor(site_url('cms/data_cpp_ldpm/excel'), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Unduh Excel"'); ?>
		</h3>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php echo form_dropdown('id_kab', $load_cities, '', 'id="id_kabup" class="form-control"'); ?>
									</div>
									<div class="form-group">
