...
<script type="text/javascript">
    ...
    $("#form_filter").submit(function(){
        ...
        table.fnReloadAjax('<?php echo site_url()?>auth/data_cppdesa/grid_filter?'+post_data);
        return false;
    });
...
function getStokAwal(){
    ...
    //var txt = $("input").val();
    $.post("<?php echo site_url()?>/ajax/get_stok_cppdesa", {id_kabupaten: id}, function(result){
        //alert (result);
