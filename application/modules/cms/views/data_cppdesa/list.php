<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title">
			<!--<?php echo anchor(site_url('auth/data_cppdesa/create'), '<i class="fa fa-plus-circle"></i> Tambah', 'class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah"'); ?>
	...
	<div class="box-body">
		...
		*<strong>DATA CPP DESA</strong> di entri oleh penyuluh/operator, admin hanya kroscek dan melakukan validasi data.<br>
