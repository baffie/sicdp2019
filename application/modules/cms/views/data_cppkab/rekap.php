<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">
            <?php echo anchor(site_url('auth/data_cppkab/cetak/'.$id_kabupaten), '<i class="fa fa-print"></i> Cetak', 'class="btn btn-danger" title="Tambah"'); ?>
            <?php echo anchor(site_url('auth/data_cppkab/excel/'.$id_kabupaten), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" title="Unduh Excel"'); ?>
        </h3>
    ...
    <div class="box-body">
        <h3 class="text-center">REKAPITULASI CADANGAN PANGAN TINGKAT KABUPATEN / KOTA</h3>
