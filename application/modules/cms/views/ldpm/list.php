...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title">
			<!--<?php echo anchor(site_url('auth/ldpm/create'), '<i class="fa fa-plus-circle"></i> Tambah', 'class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah"'); ?>
			<?php echo anchor(site_url('auth/ldpm/excel'), '<i class="fa fa-download"></i> Excel', 'class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Unduh Excel"'); ?>-->
		</h3>
	...
	<div class="box-body">
		...
		*<strong>DATA CPM LDPM</strong> di entri oleh penyuluh/operator, admin hanya kroscek dan melakukan validasi data.<br>
