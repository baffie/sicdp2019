    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row) {
            ...
            <tr>
                ...
                <td align = "left"><a href="<?php echo site_url('cms/profil/kec_ldpm/view/' . $row['id_kecamatan']); ?>"
                       title="<?php echo $row['nama_kec'] ?>" target="_blank"><?php echo $row['nama_kec'] ?></a></td>
                <td>
                    <a href="<?php echo site_url('cms/profil/kec_ldpm/view/' . $row['id_kecamatan']); ?>"
                       class="btn btn-sm btn-primary" title="Detail <?php echo $row['nama_kec'] ?>" target="_blank"><i class="fa fa-share"></i> Kelompok</a>
                       <a href="<?php echo site_url('cms/cpm/ldpm_kecamatan/view/' . $row['id_kecamatan']); ?>" class="btn btn-sm btn-primary" title="Detail <?php echo $row['nama_kec'] ?>" target="_blank"><i class="fa fa-share"></i> Wilayah</a>
                </td>
            </tr>
            <?php
        }
