...
<h3 class="text-center">REKAPITULASI DATA CPM LPM KELOMPOK TANI</h3>
...
<p class="text-left hidden-print">
    ...
    *untuk <strong>Validasi</strong> pilih menu <strong>Data</strong> -> pilih <strong>DATA CPM LPM</strong> -> Pilih Data yang akan diedit -> <strong>Edit</strong> -> pilih opsi validasi -> <strong>Update</strong>
</p>
