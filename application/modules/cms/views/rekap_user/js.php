...
<script type="text/javascript">
        ...
        columnDefs: [
            {
                "render": function(data, type, row) {
                    if (row.tanggal == '0') {
                        return '<span class="label label-default">Belum Entri</span>';
                    }
                    else {
                        return '<span class="label label-success">Sudah Entri</span>';
                    }
                }, "targets": [2]
            },
            {
    ...
    $("#form_filter").submit(function(){
        ...
        table.fnReloadAjax('<?php echo site_url()?>cms/rekap_user/grid_filter?'+post_data);
        return false;
    });
</script>