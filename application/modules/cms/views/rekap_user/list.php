...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title">
			<!--<?php echo anchor(site_url('cms/cbp_kab/create'), '<i class="fa fa-plus-circle"></i> Tambah', 'class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah"'); ?>
							...
							<div class="row">
								<div class="col-md-4">
									<!--<div class="form-group">
										...
										<?php echo form_dropdown('id_kab', $load_cities, '', 'id="id_kabupaten" class="form-control"'); ?>
									</div>-->
									 <div class="form-group">
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<select name="tahun_berdiri" id="tahun_berdiri" class="form-control select2">
											<option value="0">Tahun</option>
											<?php
											$now = date("Y");
											$tahun =('2010');
											for($year = $tahun; $year <= $tahun+10; $year++)
											{
												?>
