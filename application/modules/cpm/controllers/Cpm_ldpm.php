...
class Cpm_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_by_cpm_ldpm($poktan->id_ldpm);
        $data = array(
            'data_poktan' => $poktan
        );
        ...
        $template['content'] = $this->load->view('v_cpm_ldpm', $data, true);
    ...
    public function set()
    {
        ...
        redirect(site_url('cpm/cpm_ldpm'));
