...
class Cpm_lpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_by_cpm_lpm($poktan->id_lpm);
        $data = array(
            'data_poktan' => $poktan
        );
        ...
        $template['content'] = $this->load->view('v_cpm_lpm', $data, true);
