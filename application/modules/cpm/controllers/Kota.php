...
class Kota extends MX_Controller
{
    ...
    public function index()
    {
        ...
        //print_r($kabupaten);
        //die();
        $poktan = $this->Home_model->get_search_kota_cpm_lpm($tahun_pengadaan, $kabupaten);
        ...
        $template['title'] = 'Data CPM LPM Tingkat Kabupaten / Kota';
    ...
    public function view($id=null)
    {
                ...
                $rdkk = $this->Home_model->get_all_by_kota_cpm_lpm_test($id);
