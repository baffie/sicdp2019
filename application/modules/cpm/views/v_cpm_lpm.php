<ol class="breadcrumb mb30">
    ...
    <li>Data</li>
    <li class="active">DATA CPM LPM</li>
</ol>
<h3 class="mb15 text-center">DATA Cadangan Pangan Masyarakat (LPM) PROVINSI BANTEN</h3>
<?php echo form_open('cpm/cpm_lpm/set'); ?>
<div class="row mb15">
    <div class="col-md-2">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row)
        {
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url('cpm/cpm_lpm/'.$row['slug']); ?>" title="<?php echo $row['nama_poktan'] ?>"><?php echo $row['nama_poktan'] ?></a></td>
                ...
                <td>
                    <a href="<?php echo site_url('cpm/cpm_lpm/'.$row['slug']); ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Detail</a>
                </td>
            </tr>
            <?php
        }
