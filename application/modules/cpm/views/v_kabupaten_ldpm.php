...
<?php echo form_open('cpm/kota_ldpm/set'); ?>
<div class="row mb15">
    <!--<div class="col-md-2">
...
<table class="table table-bordered table-striped" id="mytable">
    ...
    <tr>
        ...
        <th width="200px"><!--<a href="<?php echo site_url('cpm/provinsi_ldpm'); ?>" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-share"></i> A Kabupaten</a>--></th>
    </tr>
    </thead>
    <tbody>
    <?php
