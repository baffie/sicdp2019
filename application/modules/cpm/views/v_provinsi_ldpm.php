<div class="row hidden-print">
    <div class="col-md-5">
        <?php echo form_open('cpm/provinsi_ldpm/set', array('class' => 'form-inline')); ?>
...
<h3 class="text-center">REKAPITULASI CADANGAN PANGAN CPM LDPM PROVINSI</h3>
<p>
</br>
...
<table class="table table-bordered vertical-align">
    ...
    foreach ($rdkk_data as $rdkk)
    {
        ...
        <tr>
            ...
            <td class="text-center"><?php echo number_format ($rdkk['susut'],2,',','.'); ?></td>
            <td class="text-center"><?php echo number_format ($rdkk['stok_awal'] + $rdkk['tambah'] - $rdkk['salur'] - $rdkk['susut'],2,',','.'); ?></td>
        </tr>
        <?php
    }
    ?>
