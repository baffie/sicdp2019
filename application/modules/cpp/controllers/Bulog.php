...
class Bulog extends MX_Controller
{
    ...
    public function index()
    {
     $tahun	= $this->session->userdata("tahun");
        $get_stok_awal = $this->Home_model->get_stok_awal_bulog($tahun);
        //print_r($get_stok_awal);
        //die(); 
        $get_awal_pengadaan = $this->Home_model->get_awal_pengadaan_bulog($tahun);
        //print_r($get_awal_pengadaan);
        //die();
        $rdkk = $this->Home_model->get_all_by_bulog($tahun);
        ...
        $template['title'] = 'Rekapitulasi Bulog';
    ...
    public function view($slug=null)
    {
        ...
        $rdkk = $this->Home_model->get_all_by_bulog($poktan->id_bulog);
