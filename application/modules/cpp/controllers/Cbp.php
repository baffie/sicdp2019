...
class Cbp extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $get_stok_awal = $this->Home_model->get_stok_awal_cbp($tahun);
        $get_awal_pengadaan = $this->Home_model->get_awal_pengadaan_cbp($tahun);
        $rdkk = $this->Home_model->get_all_by_cbp($tahun); 
        $rd = $this->Home_model->get_all_by_cbpkab($tahun);
        ...
        $a['total_stok'] = $total_stok;
        $a['total_stok_awal'] = $total_stok_awal;
        $a['total_penambahan'] = $total_penambahan;
        $a['total_penyaluran'] = $total_penyaluran;
        $a['total_penyusutan'] = $total_penyusutan;
        ...
        $b['tot_stok'] = $tot_stok;
        $b['tot_stok_awal'] = $tot_stok_awal;
        $b['tot_penambahan'] = $tot_penambahan;
        $b['tot_penyaluran'] = $tot_penyaluran;
        $b['tot_penyusutan'] = $tot_penyusutan;
        //print_r($rd);
        //die()
         $data= $a + $b;
        $template['title'] = 'REKAPITULASI CBP';
        $template['content'] = $this->load->view('v_cbp_detail', $data, true);
