...
class Cpp_kab extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $rdkk = $this->Home_model->get_all_by_cpp($tahun);
        $data = array(
            'rdkk_data' => $rdkk,
        );
        ...
        $template['title'] = 'REKAPITULASI CPP KAB/KOTA';
        $template['content'] = $this->load->view('v_cpp_detail', $data, true);
    ...
    public function view($slug=null)
    {
        ...
        $template['title'] = 'REKAPITULASI CPP KABUPATEN/KOTA';
