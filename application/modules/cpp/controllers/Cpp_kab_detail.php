...
class Cpp_kab_detail extends MX_Controller
{
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_kota_cpp_kab_detail($id);
                //print_r($poktan);
                //die();
                $rdkk = $this->Home_model->get_all_by_kota_cpp_kab_detail($id);
                //print_r($rdkk);
        ...
        $template['content'] = $this->load->view('v_kabupaten_cppkab_detail', $data, true);
        $template['js'] = $this->load->view('js', $data, true);
