...
class Kota extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_kota($tahun, $subsektor, $kabupaten,$kecamatan, $desa);
        ...
        $template['title'] = 'Rencana Definitif Kebutuhan Kelompok Tingkat Kabupaten / Kota';
        $template['content'] = $this->load->view('v_kabupaten', $data, true);
    ...
    public function view($id=null)
    {
        ...
        $rdkk = $this->Home_model->get_all_by_kota($id);

        $data = array(
            'rdkk_data' => $rdkk,
            'id_kab' => $id,
            'kabupaten' => $this->Kabupaten_model->get_by_id($id)->nama_kab,
        );

        $data['subsektor'] = $this->Home_model->get_subsektor_by_kota($id);
        ...
        $template['title'] = 'Rekapitulasi CPM LPM Tingkat Kabupaten/kota';
        $template['content'] = $this->load->view('v_kabupaten_detail', $data, true);
        $template['js'] = $this->load->view('js', $data, true);
