...
class Kota_cpp_ldpm extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_kota_cpp_ldpm($tahun_pengadaan, $kabupaten);
        //print_r($poktan);
        //die();
        $data = array(
            'data_poktan' => $poktan
        ...
        $template['title'] = 'Data CPP LDPM Tingkat Kabupaten / Kota';
        $template['content'] = $this->load->view('v_kabupaten_ldpm', $data, true);
    ...
    public function view($id=null)
    {
                ...
                $poktan = $this->Home_model->get_by_id_kota_cpp_ldpm($id);
                //$test = this->home_model->get_test($id);
                //print_r($test);
                //die();
                $rdkk = $this->Home_model->get_all_by_kota_cpp_ldpm($id);
                //print_r($rdkk);
                //die();
        $data = array(
            'rdkk_data' => $rdkk,
        ...
        $template['content'] = $this->load->view('v_kabupaten_ldpm_detail', $data, true);
        $template['js'] = $this->load->view('js', $data, true);
    ...
    public function set()
    {
        ...
        redirect(site_url('cpp/kota_cpp_ldpm'));
    }
