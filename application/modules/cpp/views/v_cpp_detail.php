<div class="row hidden-print">
    <div class="col-md-5">
        <?php echo form_open('cpp/cpp_kab/set', array('class' => 'form-inline')); ?>
...
<h3 class="text-center">REKAPITULASI CADANGAN PANGAN (CPP) KABUPATEN/KOTA</h3>
<p>
</br>
...
<table class="table table-bordered vertical-align">
    ...
    <tr class="active">
        ...
        <th class="text-center" width="20%" rowspan="2">Kabupaten</th>
        <th class="text-center" width="5%" rowspan="2">Awal Pengadaan</th>
        <th class="text-center" colspan="5">Rekapitulasi Cadangan Pangan Pemerintah Kab/Kota (Kg)</th>
    </tr>
    <tr class="active">
