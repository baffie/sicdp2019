...
<h3 class="mb15 text-center">DATA CADANGAN  PANGAN KABUPATEN / KOTA </h3>
<?php echo form_open('cpp/cpp_kab/set'); ?>
<div class="row mb15">
    <div class="col-md-2">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row)
        {
            ...
            <tr>
                ...
                <!--<td><a href="<?php echo site_url('profil/lpm/view/'.$row['slug']); ?>" title="<?php echo $row['nama_gapoktan'] ?>"><?php echo $row['nama_gapoktan'] ?></a></td>-->
                ...
                <td>
                    <a href="<?php echo site_url('cpp/cpp_kab/'.$row['slug']); ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Detail</a>
                </td>
            </tr>
            <?php
        }
