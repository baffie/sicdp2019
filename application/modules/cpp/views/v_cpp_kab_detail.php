<ol class="breadcrumb mb30">
    ...
    <li>Data</li>
    <li class="active">DATA CPP KAB/KOTA</li>
</ol>
<h3 class="mb15 text-center">DETAIL DATA CPP KAB/KOTA </h3>
<?php echo form_open('cpp/cpp_kab_detail/set'); ?>
<div class="row mb15">
    <!--<div class="col-md-2">
...
<table class="table table-bordered table-striped" id="mytable">
    ...
    <tr>
        <th width="50px">No</th>
        <th>Kabupaten</th>
        <th width="200px"><a href="<?php echo site_url('cpp/cpp_kab'); ?>" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-share"></i> All Kabupaten</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row)
        {
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url('cpp/cpp_kab_detail/view/'.$row['id_kabupaten']); ?>" title="<?php echo $row['id_kabupaten'] ?>"><?php echo $row['nama_kab'] ?></a></td>
                <td>
                    <a href="<?php echo site_url('cpp/cpp_kab_detail/view/'.$row['id_kabupaten']); ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Detail</a>
                </td>
            </tr>
            <?php
        }
