<ol class="breadcrumb mb30">
    ...
    <li>Data</li>
    <li class="active">PROFIL CPM LPM</li>
</ol>
<h3 class="mb15 text-center">PROFIL CPM LPM PROPINSI BANTEN</h3>
<?php echo form_open('cpp/cpp_ldpm/set'); ?>
<div class="row mb15">
    <div class="col-md-2">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row)
        {
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url('cpp/cpp_ldpm/'.$row['slug']); ?>" title="<?php echo $row['nama_gapoktan'] ?>"><?php echo $row['nama_gapoktan'] ?></a></td>
                <td><?php echo $row['alamat'] ?></td>
                <td><?php echo $row['luas_lahan'] ?></td>
                <td><?php echo $row['jumlah_anggota'] ?></td>
                <td><?php echo $row['name'] ?></td>
                <td>
                    <a href="<?php echo site_url('cpp/cpp_ldpm/'.$row['slug']); ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Detail</a>
                </td>
            </tr>
            <?php
        }
