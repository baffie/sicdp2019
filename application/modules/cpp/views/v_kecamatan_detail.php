...
<h3 class="text-center">REKAPITULASI RDKK PUPUK BERSUBSIDI<br> TINGKAT KECAMATAN</h3>
<p>
...
<table width="100%" class="mb15">
    <tr>
        <td>
            <p class="text-center">
                Mengetahui,<br>
                Camat <?php echo $kecamatan; ?><br><br><br><br><br>
        ...
        <td>
            <p class="text-center">
                Disetujui,<br>
                Kepala Balai Penyuluhan Kecamatan <?php echo $kecamatan; ?><br><br><br><br><br>
                _____________________________
            </p>
        </td>
        <td>
            <p class="text-center">
                <?php echo $kecamatan; ?>, <?php echo dateformatindo(date('d M Y'),2);?><br>
                Kepala UPTD Kecamatan <?php echo $kecamatan; ?>,<br><br><br><br><br>
                _____________________________
            </p>
        </td>
    </tr>
...
<p class="text-center hidden-print">
    <a href="javascript:window.print()">Cetak</a> | <a href="<?php echo site_url('rdkk/kecamatan/excel/'.$id_kecamatan)?>">Unduh</a> | <a href="<?php echo site_url()?>">Home</a>
</p>
