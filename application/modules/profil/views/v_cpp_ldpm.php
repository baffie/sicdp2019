<ol class="breadcrumb mb30">
    ...
    <li>Data</li>
    <li class="active">PROFIL CPP LDPM</li>
</ol>
<h3 class="mb15 text-center">PROFIL CPP LDPM PROPINSI BANTEN</h3>
<?php echo form_open('profil/cpp_ldpm/set'); ?>
<div class="row mb15">
    <!--<div class="col-md-2">
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row)
        {
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo site_url('profil/cpp_ldpm/view/'.$row['slug']); ?>" class="btn btn-sm btn-success"><i class="fa fa-share"></i> Detail</a>
                </td>
            </tr>
            <?php
        }
