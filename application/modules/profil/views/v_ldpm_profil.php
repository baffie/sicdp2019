...
<h3 class="text-center">PROFIL GAPOKTAN CPM</h3></br></br>
<div class="form-group"> 
<table border="0">
    <tr>
        <td class="text-left" width="30%"><strong><h4>Nama Gapoktan</h4></strong></td><td width="2%">:</td><td></td><td></td>
        <td class="text-left" width="75%"><strong><h4><?php echo $nama_poktan; ?></h4></strong></td>
    </tr>
    <tr><td></br></td></tr>
    <tr>
        <td class="text-left" width="100px"><strong><h4>Ketua Gapoktan</h4></strong></td><td>:</td><td></td><td></td>
    ...
    <tr><td></br></td></tr>
<!--<img src="<?php echo base_url('uploads/20170319-Taiga.png'); ?>" height="100"/>-->
