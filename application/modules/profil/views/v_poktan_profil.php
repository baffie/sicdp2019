...
<h3 class="text-center">PROFIL KELOMPOK LUMBUNG PANGAN</h3></br>
<div class="form-group">
<img itemprop="image" class="img-responsive"  align="right" src="<?php echo base_url('uploads/'.$foto); ?>" alt="" style="height:200px" > 
<table>
    <tr>
        <td class="text-left" width="20%"><strong><h4>Nama LPM</h4></strong></td><td width="5%">:</td><td></td><td></td>
        <td class="text-left" width="75%"><strong><h4><?php echo $nama_poktan; ?></h4></strong></td>
    </tr>
    <tr><td></br></td></tr>
    <tr>
        <td class="text-left" width="100px"><strong><h4>Ketua LPM</h4></strong></td><td>:</td><td></td><td></td>
        <td class="text-left" width="200px"><strong><h4><?php echo $nama_ketua; ?></h4></strong></td>
    </tr>
    <tr><td></br></td></tr>
    <tr>
    ...
    <tr>
        ...
        <td class="text-left" width="200px"><strong><h4><?php echo $awal_pengadaan; ?></h4></strong></td>
    </tr>
    <tr><td></br></td></tr>
    <tr>
    ...
    <tr>
        ...
        <td class="text-left" width="200px"><strong><h4><?php echo $total_stok_awal + $total_penambahan - $total_penyaluran; ?></h4></strong></td>
    </tr>
    <tr><td></br></td></tr>
    <tr>
