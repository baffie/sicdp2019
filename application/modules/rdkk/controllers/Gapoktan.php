...
class Gapoktan extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $poktan = $this->Home_model->get_search_desa($tahun, $kabupaten,$kecamatan, $desa);

        $data = array(
            'data_gapoktan' => $gapoktan
        );
        ...
        $template['title'] = 'DATA PROFIL CPM LDPM';
    ...
    public function view($id=null)
    {
        ...
        $data = array(
            //'rdkk_data' => $rdkk,
            'id_gapoktan' => $id_gapoktan->id_gapoktan,
            'nama_gapoktan' => $nama_gapoktan->nama_gapoktan,
            //'nama_poktan' => $gapoktan->nama_poktan,
            //'komoditas' => $gapoktan->komoditas,
            'nama_ketua' => $nama_ketua->nama_ketua,
