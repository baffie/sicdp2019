<ol class="breadcrumb mb30">
    ...
    <li>Data</li>
    <li class="active">RDKK Pupuk Bersubsidi Tingkat Kabupaten/Kota</li>
</ol>
<h3 class="mb15 text-center">RENCANA DEFINITIF KEBUTUHAN KELOMPOK (RDKK) <br>PUPUK BERSUBSIDI TINGKAT KABUPATEN/KOTA</h3>
<?php echo form_open('rdkk/kota/set'); ?>
    ...
    if($data_poktan) {
        ...
        foreach ($data_poktan as $row) {
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url('rdkk/kota/view/' . $row['id_kabupaten']); ?>"
                       title="<?php echo $row['nama_kab'] ?>"><?php echo $row['nama_kab'] ?></a></td>
                <td>
                    <a href="<?php echo site_url('rdkk/kota/view/' . $row['id_kabupaten']); ?>"
