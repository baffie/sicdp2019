<nav id="navbar-main">
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="container">
            <img class="pull-left mb5" src="<?php echo base_url('assets/img/logo2.png'); ?>" width="300" alt="Logo Provinsi Banten">
                ...
                <ul class="nav navbar-nav navbar-right mt30">
                    ...
                    <li class="dropdown <?php if ($this->uri->segment(1) == 'cpp') echo 'active'; ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">DATA<span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <!--<li><a href="<?php echo site_url('cpp/cpp_ldpm')?>">CPP LDPM</a></li>
                                    <li><a href="<?php echo site_url('cpp/cpp_kab')?>">CPP Kab/Kota</a></li>
                                    <li><a href="<?php echo site_url('cpm/kota')?>">CPM LPM TINGKAT KABUPATEN</a></li>-->
                                      <li class="dropdown dropdown-submenu">
                                                <li><a href="<?php echo site_url('cpm/kota')?>">   CPM LPM</a></li>
                                    </li>
                                    <li class="divider"></li>
                                    <li class="divider"></li>
                                    <li class="dropdown dropdown-submenu">
                                    <li><a href="<?php echo site_url('cpm/kota_ldpm')?>">   CPM LDPM</a></li>
                                    <!--<li><a href="<?php echo site_url('cpm/kota_ldpm')?>">CPM LDPM TINGKAT KABUPATEN</a></li>
                                    <li><a href="<?php echo site_url('cpm/provinsi_lpm')?>">CPM LPM TINGKAT PROVINSI</a></li>
                                    <li><a href="<?php echo site_url('cpm/provinsi_ldpm')?>">CPM LDPM TINGKAT PROVINSI</a></li>-->
                                      <li class="dropdown dropdown-submenu">
                                    </li>  
                                    <li class="divider"></li>
                                    <li class="divider"></li>
                                        <li class="dropdown dropdown-submenu">
                                        <li><a href="<?php echo site_url('cpp/cpp_kab_detail')?>">  CPP TINGKAT KABUPATEN/KOTA</a></li>
                                    </li>
                                     <li class="divider"></li>
                                    <li class="divider"></li>        
                                   <!--<li><a href="<?php echo site_url('cpp/cpp_kab')?>">CPP TINGKAT KABUPATEN/KOTA</a></li>-->
