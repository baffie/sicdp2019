	...
	<div class="container">
		...
		<!--<div class="social pull-right mt15 mb15">
			<ul>
				...
				<?php if(setting('instagram')) echo '<li><a href="'.setting('instagram').'"  target="_blank" title="Instagram"><i class="fa fa-instagram"></i></a></li>';?>            
			</ul>
		</div>-->
	</div>
	<div class="navbar navbar-default" role="navigation">
		<div class="container">
			<img class="pull-left mb5" src="<?php echo base_url('assets/img/logo.png'); ?>" width="200" alt="Logo Kabupaten Pandeglang">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right mt30">
					<li <?php if (current_url() == site_url()) echo ' class="active"'; ?>><a href="<?php echo site_url('home')?>">Home</a></li>
					...
					<li class="dropdown <?php if ($this->uri->segment(1) == 'cpp') echo 'active'; ?>">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">DATA<span class="caret"></span></a>
								<ul class="dropdown-menu">
									<!--<li><a href="<?php echo site_url('cpm/kota/view/3601')?>">REKAP CPM LPM BY KELOMPOK</a></li>
									<li><a href="<?php echo site_url('cpm/kota_ldpm/view/3601')?>">REKAP CPM LDPM BY KELOMPOK</a></li>
									<li><a href="<?php echo site_url('cpm/kecamatan')?>">REKAP CPM LPM BY AREA</a></li>
									<li><a href="<?php echo site_url('cpm/kecamatan_ldpm')?>">REKAP CPM LDPM BY AREA</a></li>-->
									<li><a href="<?php echo site_url('/cpp/cpp_desa')?>">REKAP CPP DESA</a></li>
									<li><a href="<?php echo site_url('cpp/cpp_kab_detail/view/3601')?>">REKAP CPP KABUPATEN</a></li>
					...
					<li><a href="<?php echo site_url('galeri/galeri')?>">Galeri</a></li>
				</ul>
			</div>
		</div>
	</div>
